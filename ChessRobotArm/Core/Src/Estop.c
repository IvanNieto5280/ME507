 ...
 *
 * @param motor1 Pointer to the stepper motor driver structure.
 * @param motor2 Pointer to the stepper motor driver structure.
 * @param motor3 Pointer to the stepper motor driver structure.
 *
 * @return None.
 */
								...
								stepper_motor_driver_t *motor3)
{
    ...
    TMC_SPI_Send40(packet(VMAXW, 0), motor1);
    TMC_SPI_Send40(packet(VMAXW, 0), motor2);
    TMC_SPI_Send40(packet(VMAXW, 0), motor3);
 ...
 * @return None.
 */
void Emergency_Stop_One(stepper_motor_driver_t *motor)
{
...
/**
 * @brief Reset the motors to continue in the fsm
 *
 * @param motor1 Pointer to the stepper motor driver structure.
 * @param motor2 Pointer to the stepper motor driver structure.
 * @param motor3 Pointer to the stepper motor driver structure.
